(() => {
  ...
  var require_codemirror = __commonJS({
    "node_modules/codemirror/lib/codemirror.js"(exports, module) {
      (function(global, factory) {
        ...
        CodeMirror3.version = "5.65.12";
        return CodeMirror3;
      });
    }
  });

  // ns-hugo:/home/runner/work/tour-of-wgsl/tour-of-wgsl/assets/third_party/codemirror/wgsl-mode.js
  var require_wgsl_mode = __commonJS({
    "ns-hugo:/home/runner/work/tour-of-wgsl/tour-of-wgsl/assets/third_party/codemirror/wgsl-mode.js"(exports, module) {
      (function(mod) {
        ...
        "use strict";
        let indentStep = 2;
        CodeMirror3.defineMode("wgsl", function(config) {
            ...
            return function(stream, state) {
              ...
              for (var i = 0; i < curState.length; i++) {
                ...
                if (matches) {
                  ...
                  if (rule.data.indent)
                    state.indent.push(stream.indentation() + indentStep);
                  if (rule.data.dedent)
                    state.indent.pop();
  ...
  `);
    ...
    `);
        ...
        CodeMirror3.defineMIME("text/wgsl", "wgsl");
      });
    }
  });
  ...
  // ns-hugo:/home/runner/work/tour-of-wgsl/tour-of-wgsl/assets/ts/wgsl-tour.ts
  var import_codemirror = __toESM(require_codemirror());
  var import_wgsl_mode = __toESM(require_wgsl_mode());

  // ns-hugo:/home/runner/work/tour-of-wgsl/tour-of-wgsl/assets/ts/wgsl-docs.ts
  var _WGSLDocs = class {
    static getDocsFor(name, type) {
      if (this.callbacks.hasOwnProperty(type)) {
        return this.callbacks[type](name);
      }
      return void 0;
    }
    static intrinsicDocs(name) {
  ...
  var WGSLDocs = _WGSLDocs;
  __publicField(WGSLDocs, "callbacks", {
    intrinsic: _WGSLDocs.intrinsicDocs.bind(_WGSLDocs),
    "variable-3": _WGSLDocs.var3.bind(_WGSLDocs),
    meta: _WGSLDocs.meta.bind(_WGSLDocs)
  });
  __publicField(WGSLDocs, "intrinsics", {
...
(e<sup>arg</sup> + e<sup>\u2212arg</sup>)\xF72, but not necessarily computed that way.
Component-wise when T is a vector`,
...
S is AbstractFloat, f32, or f16
T is S or vecN&ltS&gt;
Converts radians to degrees, approximating e1 \xD7 180 \xF7 \u03C0.
Component-wise when T is a vector`,
...
S is AbstractFloat, f32, or f16
T is S or vecN&ltS&gt;
Converts degrees to radians, approximating e1 \xD7 \u03C0 \xF7 180.
...
radians. Approximates the pure mathematical function (e<sup>arg</sup> \u2212 e<sup>\u2212arg</sup>)\xF72,
...
(e<sup>arg</sup> \u2212 e<sup>\u2212arg</sup>) \xF7 (e<sup>arg</sup> + e<sup>\u2212arg</sup>)
but not necessarily computed that way.
Component-wise when T is a vector.`,
...
\u230A 0.5 + 127 \xD7 min(1, max(-1, e[i])) \u230B which is then placed in bits 8 \xD7 i
through 8 \xD7 i + 7 of the result.`,
...
\u230A 0.5 + 255 \xD7 min(1, max(0, e[i])) \u230B which is then placed in bits 8 \xD7 i through
8 \xD7 i + 7 of the result.`,
...
\u230A 0.5 + 32767 \xD7 min(1, max(-1, e[i])) \u230B which is then placed in bits 16 \xD7 i through
16 \xD7 i + 15 of the result.`,
...
\u230A 0.5 + 65535 \xD7 min(1, max(0, e[i])) \u230B which is then placed in bits
16 \xD7 i through 16 \xD7 i + 15 of the result.`,
...
then placed in bits 16 \xD7 i through 16 \xD7 i + 15 of the result.
...
Component i of the result is max(v \xF7 127, -1), where v is the interpretation of bits
8\xD7i through 8\xD7i + 7 of e as a twos-complement signed integer.`,
...
Component i of the result is v \xF7 255, where v is the interpretation of bits 8\xD7i
through 8\xD7i + 7 of e as an unsigned integer.`,
...
a signed normalized floating point value.
Component i of the result is max(v \xF7 32767, -1), where v is the interpretation of
bits 16\xD7i through 16\xD7i + 15 of e as a twos-complement signed integer.`,
    unpack2x16unorm: `@const @must_use
fn unpack2x16unorm(e: u32) -> vec2<f32>
Decomposes a 32-bit value into two 16-bit chunks, then reinterprets each chunk as
an unsigned normalized floating point value.
Component i of the result is v \xF7 65535, where v is the interpretation of bits 16\xD7i
through 16\xD7i + 15 of e as an unsigned integer.`,
...
interpretation of bits 16\xD7i through 16\xD7i + 15 of e as an IEEE-754 binary16 value.`,
...
operations in the workgroup address space.`
  ...
  __publicField(WGSLDocs, "predeclared_names", {
...
Order in memory (b, g, r, a)`
  ...
  __publicField(WGSLDocs, "attributes", {
...
The x value is required, y, z are optional, defaulting to 1.`
  ...
  var WGSLTour = class extends HTMLElement {
    ...
    connectedCallback() {
      const tmplNode = document.getElementById("wgsl-tour-tmpl");
      const tmpl = tmplNode.content.cloneNode(true);
      const shadow = this.attachShadow({ mode: "open" });
      shadow.appendChild(tmpl);
      const textarea = shadow.getElementById("wgsl-shader");
      ...
      this.editor = import_codemirror.default.fromTextArea(textarea, {
        autofocus: true,
        lineNumbers: true,
        mode: "wgsl",
        dragDrop: false,
      ...
      this.editor.on("changes", () => {
        if (this.key_timer !== void 0) {
          clearTimeout(this.key_timer);
        }
        this.key_timer = setTimeout(rebuild, 1e3);
      });
     ...
     **/
    async setVisualizationBuilder(val) {
      ...
      try {
        ...
        this.onPipelineFailure({ message: e });
        return false;
      }
      this.buildVisualization();
    }
    ...
    buildVisualization() {
      ...
      this.visualization = void 0;
      this.visualizationBuilder.build(this.editor.getValue() + this.bootstrap).then((visualization) => {
        this.visualization = visualization;
        requestAnimationFrame(this.frame.bind(this));
      }).catch((err) => {
        if (err.hasOwnProperty("diagnostics")) {
          this.onCompilationFailure(err);
        } else if (err.hasOwnProperty("visualizer_error")) {
          this.onPipelineFailure(err);
        } else {
          console.log(err);
        }
      });
